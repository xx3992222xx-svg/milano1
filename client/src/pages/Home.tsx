...
export default function Home() {
  ...
  const heading = useMemo(() => ["products", "categoryProducts", "categorySort", "inventory", "orders", "orderList"].includes(view) ? null : <PageHeading locale={locale} view={view} onAdd={handleAdd} />, [locale, view]);
