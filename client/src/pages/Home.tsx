...
type View = "dashboard" | "conversations" | "channels" | "settings" | "products" | "orders" | "purchases" | "analytics" | "discounts" | "reviews" | "shipping" | "payments" | "expenses" | "reports" | "addProductMenu" | "productList" | "inventory" | "orderList" | "pointOfSale" | "externalOrder";
...
function ProductEditor({ locale }: { locale: Locale }) {
  ...
  const addSize = () => { const value = sizeInput.trim().toUpperCase(); if (value && !sizes.includes(value)) { setSizes([...sizes, value]); setSizeInput(""); } };
